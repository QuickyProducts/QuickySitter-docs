...
- **Fix**: On furniture with many poses and props the prop script could run out of memory and crash on early 1.25 (visible as "Stack-Heap Collision" in chat, and the Quicky HUD no longer attached). The script now uses less memory than 1.24 did.
